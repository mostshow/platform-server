username:root
password:111111
db.users.save({ username: 'root', password: '$2a$10$PiKIeoP6XWUM7J6LpeSPv.uqVcl8ZVw6MXQvrryC46VlQ9/9CnG/2', email: 'root@root.com', roleId: ObjectId("58ac2426a46c7dc66058e906"),createAt: new Date(), updateAt: new Date() });
